...
import family from '../../TREKK TRAVEL ASSETSS/HOME PAGE/EMOJIS/family-icon.webp'
                    ...
                    {image.map((items) => {
                        ...
                        return (
                            ...
                            <div className='relative flex-shrink-0 rounded-2xl w-[350px] h-60 bg-black'>
                                ...
                                <button onClick={()=>navigateFamilyDetails(items._id)} className='absolute top-[190px] text-white border  py-1 border-1 border-white px-2 rounded right-3'>View Deal</button>
                            </div>
                        )
                    })}
