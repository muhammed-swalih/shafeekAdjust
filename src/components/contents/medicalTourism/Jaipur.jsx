        ...
        return (
            <div className=' w-full h-auto min-h-screen '>
                ...
                <div className=' w-[800px] min-h-screen h-auto mx-auto py-14 pt-32
                 '>
                    <div>
                        <h1 className=' uppercase text-3xl text-center text-orange-500 font-medium'>jaipur</h1>
                    </div>
                    <div>
                        <h1 className=' mt-10 font-medium'>
                            Being 6th as far as drawing in outside voyagers and an ideal traveller goal, the vivid
                            territory of Rajasthan urges sightseers to rush here with the soul of Padharo Mhare Des
                            which actually signifies 'Welcome to my property.' Now, it offers significantly more than
                            simply culture and legacy by bit by bit making arrangements to update itself into a
                            much looked for after clinical vacationer goal. The significant purpose behind the state
                            to prosper in this section is the way that it has consistently been a vacationer inviting.
                            The nearness of existing multi claim to fame clinics is supporting in building the state
                            as a clinical centre also. The state is likewise generally known for treatment through
                            conventional types of medicine including AYUSH, a significant draw factor for clinical
                            traveller’s. <br /><br />


                            While enquiring about the go-to put for clinical the travel industry in the state.
                            Understanding the monetary lift that clinical the travel industry could bring into the
                            express, the Government of Rajasthan is investing in purposeful amounts of energy
                            alongside the private segment significantly in Jaipur, which is a piece of the brilliant
                            triangle, a vacationer circuit which interfaces the national capital Delhi, Agra and Jaipur.
                            Be it by offering concession for gaining area or facilitating the arrangement techniques
                            for medical clinics, the state government is urging multispecialty emergency clinics to
                            set up their base.
