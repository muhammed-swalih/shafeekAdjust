...
function ThekkadyResorts() {
    const navigate = useNavigate()
    const navigateResort = (id) => {
        navigate(`/thekkadyresort/${id}`)
    }

    const [resort, setResort] = useState([])
    const handleNextImage = () => {
        document.getElementById('thekkady').scrollLeft -= 500
    }
    ...
    const fetchHoneyMoonPackage = async () => {
        const response = await axios.get('https://easytuitionapi.cloud/packages/thekkady');
            ...
            <div className=' pb-14 w-full h-auto bg-[#EBEBEB]  '>
                <div className=' flex w-[1150px] mx-auto  flex-col gap-3'>
                    ...
                    <div className='flex justify-between'>
                        <h1 className=' font-semibold text-4xl flex gap-2'>Best Thekkady Resort</h1>
                    ...
                    <div id='thekkady' className='relative scroll-smooth flex gap-3 overflow-scroll hide-scrollbar rounded-2xl mt-5'>
                        {resort.map((items) => {
                            ...
                            return (
                                ...
                                <div className='relative flex-shrink-0 rounded-2xl w-[350px] h-60 bg-black'>
                                    ...
                                    <button onClick={navigateResort} className='absolute top-[190px] text-white border font-semibold py-1 border-1 border-white px-2 rounded right-3'>View Deal</button>
                                </div>
                            )
                        })}
        ...
        <div className=' w-full h-auto bg-[#EBEBEB] mt-[-8px]'>
            <div className=' w-full h-auto bg-[#EBEBEB]  py-5'>
                <div className=' px-5'>
                    ...
                    <h1 className=' text-xl font-bold flex inline-flex gap-1'>Best Thekkady Resorts <span><img src='' alt="" width={30} /></span></h1>
...
export default ThekkadyResorts