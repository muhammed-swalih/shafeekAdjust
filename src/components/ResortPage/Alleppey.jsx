        ...
        return (
            ...
            <div className=' flex w-[1150px] mx-auto  flex-col gap-3'>
                ...
                <div className='flex justify-between'>
                    <h1 className=' font-semibold text-4xl flex gap-2'>Best Alleppey Resort</h1>
                            ...
                            return (
                                ...
                                <div className=' relative flex-shrink-0 w-3/4 h-60 shadow-xl bg-black rounded-lg'>
                                    ...
                                    <div className='absolute top-[152px] ml-[-15px] font-bold text-black left-5   '>
                                        <h1 className='  my-1 font-light text-white rounded-sm px-1 text-lg w-2/3 h-auto pr-2'>{items ? items.place : "place name"}</h1>
                                    </div>
                                    <div onClick={() => {
...
export default AlleppeyResorts