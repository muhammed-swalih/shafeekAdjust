...
function ThrissurDetails() {
    ...
    const getDetails = () => {
        ...
        axios(`https://easytuitionapi.cloud/packages/getthrissur/${id}`)
            .then(response => {
    ...
    if (isMediumScreen) {
        return (
            ...
            <Navbar/>
            <div className=' w-[1150px] min-h-screen h-auto bg-[#EBEBEB] pt-32 pb-10'>
...
export default ThrissurDetails