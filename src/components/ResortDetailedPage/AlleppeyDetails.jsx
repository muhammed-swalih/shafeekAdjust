...
function AlleppeyDetails() {
    ...
    const getDetails = () => {
        ...
        axios(`https://easytuitionapi.cloud/packages/getalleppey/${id}`)
            .then(response => {
            ...
            <div className=' w-full h-auto bg-[#EAE7E7]  '>
                <div className='flex flex-col'>
                    ...
                    <div className=' px-4 py-5 bg-white'>
                        ...
                        <a href="https://wa.me/9947172630" target="_blank"><h1 className=' uppercase text-white py-1 '><a href="https://wa.me/1234567890">get a quote</a> </h1></a>
                        </div>
